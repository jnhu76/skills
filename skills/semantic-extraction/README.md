...
```bash
.claude/skills/semantic-extraction/
```
...
```text
Use the semantic-extraction skill to analyze this system and find research gaps.
```

Example:

```text
请用 semantic-extraction skill 分析 CubeSandbox：
1. 抽出第一性目标
2. 基本操作
3. 对象/状态/effect
4. 语义规则
